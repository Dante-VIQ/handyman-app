        ...
        <!-- ===== CONTACT HERO ===== -->
        <section
            class="relative bg-gradient-to-br from-amber-50 via-white to-amber-50/30 py-16 md:py-24 overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-5 sm:px-8 relative z-10">
                <div class="max-w-3xl">
                    ...
                    <div class="flex flex-wrap gap-4 mt-10">
                        <a href="#contact-form"
                            class="bg-gray-900 hover:bg-gray-800 text-white px-8 py-4 rounded-xl font-bold shadow-lg flex items-center gap-2 transition-all"><i
        ...
        <section class="max-w-7xl mx-auto px-5 sm:px-8 -mt-8 relative z-20">
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 contact-card transition-all border border-gray-100">
                    ...
                    <p class="text-gray-500 text-lg font-semibold">0161 234 5678</p>
                    <p class="text-gray-400 text-sm mt-2">Mon-Fri 8am-8pm • Sat 9am-5pm<br>Sun emergency only</p>
                    <a href="tel:01612345678"
                        class="inline-block mt-4 text-amber-600 font-semibold hover:underline">Call now <i
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 contact-card transition-all border border-gray-100">
                    ...
                    <p class="text-gray-500 text-lg font-semibold">hello@gbhandyman.co.uk</p>
                    <p class="text-gray-400 text-sm mt-2">We reply within 1 hour during work hours</p>
                    <a href="mailto:hello@gbhandyman.co.uk"
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 contact-card transition-all border border-gray-100">
                    ...
                    <a href="service-area.html"
                        class="inline-block mt-4 text-amber-600 font-semibold hover:underline">View service area <i
                            class="fas fa-arrow-right ml-1 text-sm"></i></a>
                </div>
            </div>
        </section>
        ...
        <section id="contact-form" class="max-w-7xl mx-auto px-5 sm:px-8 py-20">
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <div>
                    <span
                        class="bg-amber-100 text-amber-700 px-4 py-1.5 rounded-full text-sm font-semibold inline-block"><i
                ...
                <div>
                        ...
                        <div class="space-y-5">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-bold">0161 234 5678</p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-bold">hello@gbhandyman.co.uk</p>
                    ...
                    <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                        ...
                        <div class="p-5">
                            ...
                            <a href="#"
                                class="inline-block mt-3 text-amber-600 font-semibold hover:underline">Get directions
            ...
            <div class="grid md:grid-cols-3 gap-8 mt-16">
                <div class="bg-white p-6 rounded-2xl shadow-md">
                    <h3 class="font-bold text-lg flex items-center gap-2"><i
                            class="fas fa-pound-sign text-amber-500"></i> Do you give free quotes?</h3>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md">
                    <h3 class="font-bold text-lg flex items-center gap-2"><i
                            class="fas fa-credit-card text-amber-500"></i> What payment do you take?</h3>
                ...
                <div class="flex flex-wrap justify-center gap-5 mt-10">
                    <a href="tel:01612345678"
                        class="bg-amber-500 hover:bg-amber-600 text-gray-900 font-bold px-10 py-5 rounded-full text-lg shadow-2xl transition-all"><i
                            class="fas fa-phone-alt mr-2"></i> Call 0161 234 5678</a>
                    <a href="#contact-form"
    ...
    <!-- floating chat icon -->
    <div
        class="fixed bottom-6 right-6 bg-amber-500 text-white p-4 rounded-full shadow-2xl cursor-pointer hover:bg-amber-600 transition-all">
