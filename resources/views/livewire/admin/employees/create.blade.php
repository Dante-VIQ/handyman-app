<div class="max-w-5xl bg-white p-6 rounded-xl shadow-md space-y-6">
        ...
        <form wire:submit.prevent="save">
            ...
            <div class="space-y-1">
                ...
                <input type="file" accept="image/jpg, image/png, image/jpeg, image/webp" wire:model="profile_image"
