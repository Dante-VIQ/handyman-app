...
@section('content')
    ...
    <div class="grid lg:grid-cols-3 gap-8 mb-16">
        <!-- Phone Card -->
        <div
            class="bg-white/80 p-8 rounded-[3rem] border border-soft-blue soft-shadow text-center hover-lift transition-soft">
            <div class="w-20 h-20 bg-soft-yellow rounded-full flex items-center justify-center text-3xl mx-auto mb-4">📞
            </div>
            ...
            <a href="tel:+12024601753" class="text-lg sm:text-xl font-bold text-[#166b8a] hover:underline block mb-2">+1 202-460-1753</a>
            <p class="text-sm text-[#4a7e93]">Mon-Fri 7am-7pm · Sat 8am-4pm</p>
        </div>

        <!-- Email Card -->
        <div
            class="bg-white/80 p-8 rounded-[3rem] border border-soft-green soft-shadow text-center hover-lift transition-soft">
            ...
            <a href="mailto:gbhandymanllc@yahoo.com"
                class="text-md sm:text-xl  font-bold text-[#166b8a] hover:underline break-all">gbhandymanllc@yahoo.com</a>
            <p class="text-sm text-[#4a7e93] mt-2">Response within 2 hours</p>
        </div>

        <!-- Visit Card -->
        <div
            class="bg-white/80 p-8 rounded-[3rem] border border-soft-yellow soft-shadow text-center hover-lift transition-soft">
            <div class="w-20 h-20 bg-soft-green rounded-full flex items-center justify-center text-3xl mx-auto mb-4">📍
            </div>
            <h2 class="text-2xl font-bold text-[#115e7a] mb-3">Visit Our Base</h2>
            <p class="text-lg text-[#2a647a] mb-4">Kent, Washington</p>
            <address class="not-italic text-xl font-semibold text-[#166b8a]">6249 S 242nd Place<br>Bldg 8 Apt 203<br>Kent,
                WA 98032</address>
            <a href="https://maps.google.com/?q=6249+S+242nd+Pl+Kent+WA" target="_blank" rel="noopener"
                class="inline-block mt-4 text-soft-blue underline text-soft-green">Get Directions →</a>
        </div>
    </div>
    ...
    <div class="bg-soft-green/20 rounded-[4rem] p-10 soft-shadow border border-soft-green/60 mb-16">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-white p-6 rounded-3xl">
                ...
                <p class="mt-2 text-[#306f86]">Yes! We offer free, no-obligation estimates for all projects. Call us or fill
                    out the form above to schedule.</p>
            </div>
            <div class="bg-white p-6 rounded-3xl">
                <h3 class="font-bold text-lg">How soon can you come to my location?</h3>
                <p class="mt-2 text-[#306f86]">We typically have availability within 2-3 days. Emergency repairs may be
                    accommodated sooner.</p>
            </div>
            <div class="bg-white p-6 rounded-3xl">
                <h3 class="font-bold text-lg">Do you serve my city?</h3>
                <p class="mt-2 text-[#306f86]">We serve Kent, Auburn, Seattle, Tacoma, Olympia, Bellevue, Redmond, Kirkland,
                    Bothell, Issaquah, Federal Way, Puyallup, Everett, Lacey, and 10+ more cities.</p>
            </div>
            <div class="bg-white p-6 rounded-3xl">
                <h3 class="font-bold text-lg">Are you licensed and insured?</h3>
                <p class="mt-2 text-[#306f86]">Absolutely. GB Handyman Solutions is fully licensed, bonded, and insured for
                    your protection.</p>
            </div>
        </div>
    </div>
