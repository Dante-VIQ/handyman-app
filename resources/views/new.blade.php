    ...
    <section id="services" class="max-w-7xl mx-auto px-5 sm:px-8 py-5">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            <!-- service card 1 -->
            <div
                class="bg-gradient-to-br from-gray-50 via-teal-50 to-gray-50 backdrop-blur-sm p-6 rounded-3xl shadow-lg hover-lift transition-all border border-blue-100/50 hover:border-blue-200">
                <div
                    class="bg-gradient-to-br from-amber-100 to-amber-200 w-16 h-16 rounded-2xl flex items-center justify-center text-3xl text-amber-700 mb-5 shadow-sm">
                    <i class="fas fa-wrench"></i>
                </div>
                <h3 class="text-xl font-bold mb-2 text-[#0a3b5c]">General repairs</h3>
                <p class="text-[#1a4b6e]/80">Squeaky doors, broken hinges, drywall patches, furniture assembly – we
                    tackle the list.</p>
            </div>
            <!-- 2 -->
            <div
                class="bg-gradient-to-br from-green-50 via-teal-50 to-blue-50 p-6 rounded-3xl shadow-lg hover-lift transition-all border border-blue-100/50 hover:border-blue-200">
                <div
                    class="bg-gradient-to-br from-amber-100 to-amber-200 w-16 h-16 rounded-2xl flex items-center justify-center text-3xl text-amber-700 mb-5 shadow-sm">
                    <i class="fas fa-shower"></i>
                </div>
                <h3 class="text-xl font-bold mb-2 text-[#0a3b5c]">Plumbing & leaks</h3>
                <p class="text-[#1a4b6e]/80">Dripping taps, clogged drains, toilet repairs, and washing machine
                    installation.</p>
            </div>
            <!-- 3 -->
            <div
                ...
                <h3 class="text-xl font-bold mb-2 text-[#0a3b5c]">Electrical basics</h3>
                <p class="text-[#1a4b6e]/80">Light fittings, socket changes, fuse board trips, and smart home installs
                    (certified).</p>
            </div>
            <!-- 4 -->
            <div
                ...
                <h3 class="text-xl font-bold mb-2 text-[#0a3b5c]">Painting & decorating</h3>
                <p class="text-[#1a4b6e]/80">Interior painting, wallpaper removal, touch‑ups – crisp finishes
                    guaranteed.</p>
            </div>
            <!-- 5 -->
            <div
                ...
                <h3 class="text-xl font-bold mb-2 text-[#0a3b5c]">Carpentry & shelving</h3>
                <p class="text-[#1a4b6e]/80">Fitted shelves, skirting boards, door hanging, garden deck repairs.</p>
            </div>
            <!-- 6 -->
            <div
                class="bg-gradient-to-br from-green-50 via-teal-50 to-blue-50 p-6 rounded-3xl shadow-lg hover-lift transition-all border border-blue-100/50 hover:border-blue-200">
                ...
                <h3 class="text-xl font-bold mb-2 text-[#0a3b5c]">TV & wall mounting</h3>
                <p class="text-[#1a4b6e]/80">Secure, level mounting of TVs, shelves, mirrors, and artwork – no drama.
                </p>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-5 sm:px-8 grid md:grid-cols-2 gap-14 items-center">
            ...
            <div class="grid grid-cols-2 gap-4">
                <img src="/images/glen.jpg"
                    class="rounded-2xl shadow-xl row-span-2 object-cover h-full w-full" alt="handyman at work">
                <img src="/images/clean.jpg"
                    class="rounded-2xl shadow-lg object-cover w-full h-48" alt="tools">
                <img src="/images/capenter.jpg"
                    class="rounded-2xl shadow-lg object-cover w-full h-48" alt="customer">
            </div>
        </div>
    </section>
