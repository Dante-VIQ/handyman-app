    ...
    <div class="max-w-2xl mx-auto py-10">
        <x-card class="p-10">
            ...
            <form action="{{ route('images.update', $image->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6 text-black font-semibold">
                    <label class="inline-block text-lg mb-2">Current Before Image</label>
                ...
                <div class="mb-6 text-black font-semibold">
                    <label for="image" class="inline-block text-lg mb-2">Before Image</label>
                ...
                <div class="mb-6 text-black font-semibold">
                    <label class="inline-block text-lg mb-2">Current After Photo</label>
                ...
                <div class="mb-6 text-black font-semibold">
                    <label for="photo" class="inline-block text-lg mb-2">After Photo</label>
                ...
                <div class="mb-6 text-black font-semibold">
                    <button type="submit" class="bg-primary rounded py-2 px-4 text-black font-semibold">Update Image</button>
                </div>
            </form>
        </x-card>
    </div>
